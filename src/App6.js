            ...
            <div className="middle_div" >
                ...
                <div className="inner_div">
                    <div className='inner_div_left_top'>
                        ...
                        <div className='inner_top_left_top_mid1'>Currency</div>
                    ...
                    <div className='inner_div_left_bottom'>
                        <div className='inner_div_left_bottom_top'>Whitelist</div>
                        ...
                        <div className='inner_div_left_bottom_lastinput'></div>
                    </div>
                    <div className='inner_div_right_top'>
                        <div className="inner_div_right_top_top">
                            <div className='inner_div_right_top_top_left'>
                                <div className="inner_div_right_top_top_left_heading1">Logo Url *</div>
